    ...
    <div className="app">
      ...
      <header className="hero">
        <div className="container">
          ...
          <a href={`https://wa.me/${whatsappNo}?text=Hello, I'm interested in your transport services.`} className="cta-button fade-up delay-2">Get a Quote on WhatsApp</a>
        </div>
      </header>
        ...
        <div className="container">
          ...
          <div className="contact-grid">
            ...
            <AnimatedSection className="contact-card">
              <span className="contact-icon">💬</span>
              <h3>WhatsApp Us</h3>
              <p><a href={`https://wa.me/${whatsappNo}?text=Hello, I'm interested in your transport services.`} target="_blank" rel="noopener noreferrer" style={{ color: 'white', textDecoration: 'none' }}>{whatsappNo}</a></p>
            </AnimatedSection>
          </div>
        </div>
      </section>
